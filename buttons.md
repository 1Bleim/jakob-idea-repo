...
For the styling in CSS, I found a [reddit thread](https://www.reddit.com/r/html5/comments/u7o29l/how_to_create_a_button_that_works_as_a_link_to) by user u/rapidtab. The reply by user u/ole1993 gave an example of how to style buttons, with which I played around and adjusted it a bit to my liking. I copied his basic structure for the button, adjusted the colors and padding, and added a border, changed the width and text size a bit until I was happy with the result. For that, I mainly hosted the website locally on my PC and inspected the page elements where I could make and see the adjustments until I was happy. Here is the final CSS styling:
